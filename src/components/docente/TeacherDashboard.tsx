        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <div className="text-right">
              <p className="text-sm font-medium text-slate-900">{teacherName}</p>
      ...
      <main className="max-w-6xl mx-auto p-6">
        {activeModule === 'proyectos' ? (
          ...
          <>
            {/* Welcome */}
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>Bienvenido, {teacherName}</h2>
                ...
                >
                  <div className="flex items-start gap-4">
                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 ${mod.active ? mod.color : 'bg-slate-100'}`}>
                      <mod.icon className={`w-6 h-6 ${mod.active ? 'text-white' : 'text-slate-400'}`} />
                    </div>
