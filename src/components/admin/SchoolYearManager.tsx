...
export default function SchoolYearManager() {
  ...
  // Filter rows by cycle filter state
    ...
    <div className="space-y-8 fade-in max-w-7xl mx-auto pb-12">
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          {/* Cycle filter pills */}
          <div className="flex items-center gap-1.5 bg-slate-100/80 p-1.5 rounded-xl border border-slate-200 shrink-0">
            <button
        ...
        {filteredRows.length === 0 ? (
          <div className="text-center py-16 card-crema text-tertiary">
            ...
            <p className="text-sm font-medium">No se encontraron grados activos configurados en el sistema para este filtro.</p>
          </div>
        ) : (
            ...
            {activeCycles.map(cycleKey => {
              ...
              return (
                <div key={cycleKey} className="space-y-4">
                  ...
                  {/* Responsive grid of interactive grade cards */}
