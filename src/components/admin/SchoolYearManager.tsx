      ...
      <div className="space-y-6">
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex flex-wrap items-center gap-3 self-start lg:self-auto">
            <div className="flex items-center gap-1.5 bg-slate-100/80 p-1.5 rounded-xl border border-slate-200 shadow-3xs">
              <button
                type="button"
        ...
        {rows.length === 0 ? (
          ...
          <div className="space-y-8">
            {activeCycles
              .filter(c => selectedCycle === 'all' || c === selectedCycle)
              .map(cycleKey => {
...
function GradeMigrationCard({
  ...
  return (
    <motion.div
      ...
      className="bg-white rounded-2xl border border-slate-200/80 p-5 flex flex-col justify-between hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 relative group/card overflow-hidden min-h-[380px]"
    >
