        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Control diario</p>
            </div>
          </div>
          <p className="text-xs text-slate-400">Módulo en desarrollo</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-5">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-500">Infracciones</p>
            </div>
          </div>
          <p className="text-xs text-slate-400">Módulo en desarrollo</p>
        </div>
