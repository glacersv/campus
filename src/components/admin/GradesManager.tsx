      ...
      {filtered.length > 0 && (
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 bg-white border border-slate-200/80 rounded-2xl p-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[10px] text-secondary font-bold uppercase tracking-wider block">Grados Activos</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[10px] text-secondary font-bold uppercase tracking-wider block">Secciones Totales</span>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <span className="text-[10px] text-secondary font-bold uppercase tracking-wider block">Alumnos Matriculados</span>
