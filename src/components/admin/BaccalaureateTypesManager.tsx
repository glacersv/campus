            ...
            >
              ...
              {/* Content */}
                <div className="pt-1 pl-5">
                  ...
                  <p className="text-xs text-tertiary mt-1">Grados: 10° - {t.maxGrade}°</p>
                </div>
          ...
          <table className="w-full">
            <thead className="table-header">
              <tr>
                ...
                <th className="text-left px-3 py-2 text-[11px] font-semibold text-secondary uppercase">Grado Máximo</th>
                <th className="text-left px-3 py-2 text-[11px] font-semibold text-secondary uppercase">Rango</th>
            ...
            <tbody>
              {filtered.map((t, i) => (
                ...
                >
                  ...
                  <td className="px-3 py-2 text-sm text-secondary">10° - {t.maxGrade}°</td>
