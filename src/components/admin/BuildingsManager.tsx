                    ...
                    <div>
                      ...
                      {b.description && (
                        <p className="text-xs text-slate-500 flex items-center gap-1 mt-0.5">
                          <MapPin className="w-3 h-3 text-slate-400" /> <span className="truncate max-w-[120px]">{b.description}</span>
                        </p>
                      )}
                    </div>
                  </div>
                  <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider shrink-0">{stats.totalCapacity} cupos</span>
                </div>

                {stats.totalSections > 0 && (
                  <p className="text-[10px] text-slate-400 mt-3 font-semibold uppercase tracking-wider leading-relaxed">
