          ...
          <>
            <div className="grid grid-cols-4 gap-3 mb-4">
              {[
                ...
                { num: stats.pendientes, label: 'En revisión', icon: Clock, color: 'text-amber-600' },
            ...
            return p ? (
              <>
                ...
                <div className="flex gap-2 justify-end">
                  ...
                  <button className="form-input !w-auto bg-amber-50 text-amber-800 border-amber-200 hover:bg-amber-100"
      ...
      <div className="flex justify-between items-start gap-3">
        <div className="flex-1 min-w-0">
          ...
          {p.estado === 'aprobado_oficial' && (
            <div className={`text-[11px] mt-2 ${p.complemento_informatica ? 'text-emerald-700' : 'text-amber-700'}`}>
...
function DetalleProyecto({ proyecto: p, rol, verHistorial, onToggleHistorial, onVolver, onEditar }: {
  ...
  return (
    <div>
      ...
      {p.observaciones && (
        <div className="bg-amber-50 text-amber-800 border border-amber-200 rounded-xl px-4 py-3 text-sm mb-3">
