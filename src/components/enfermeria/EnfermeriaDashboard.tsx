...
import { ClipboardCheck, Bell, BookOpen, School, Calendar, CalendarDays, Medal } from 'lucide-react';
...
export default function EnfermeriaDashboard() {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-2">
        <h2 className="text-2xl font-bold text-slate-900" style={{ fontFamily: 'var(--font-display)' }}>Enfermería</h2>
        ...
        {availableModules.map((mod, i) => {
          ...
          return (
            <motion.div
              ...
              onClick={() => navigate(`/enfermeria/${mod.id}`)}
